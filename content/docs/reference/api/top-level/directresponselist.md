---
title: DirectResponseList
weight: 50
description: API reference for DirectResponseList
---

# DirectResponseList API Reference
...
| `kind` _string_ | `DirectResponseList` | | |
...
| `items` _[DirectResponse](#directresponse) array_ |  |  |  |
...
_Appears in:_
- [DirectResponseList](#directresponselist)
